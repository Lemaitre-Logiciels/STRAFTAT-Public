...
Shader "S_Lava_BC"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 appendResult35 = (float3(0.0 , ase_vertexNormal.y , 0.0));
			float mulTime13 = _Time.y * _time;
			float temp_output_18_0 = frac( ( ( v.texcoord.xy.x * _wavelength ) + mulTime13 ) );
			v.vertex.xyz += ( appendResult35 * ( _displacementstrength * ( saturate( ( ( 1.0 - temp_output_18_0 ) * temp_output_18_0 * 4.0 ) ) * ase_vertexNormal.y ) ) );
			v.vertex.w = 1;
		}
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Albedo = ( _Color0 * float4( desaturateVar30 , 0.0 ) ).rgb;
...
Node;AmplifyShaderEditor.RangedFloatNode;14;-2340.652,778.1699;Inherit;False;Property;_time;time;2;0;Create;True;0;0;0;False;0;False;1;0.71;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;25;-160.3264,310.652;Inherit;False;Property;_displacementstrength;displacement strength;4;0;Create;True;0;0;0;False;0;False;1;1.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;22;-2284.686,560.9016;Inherit;False;Property;_wavelength;wavelength;3;0;Create;True;0;0;0;False;0;False;5;10.37;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;11;-402.7367,150.8679;Inherit;False;Property;_boost;boost;1;0;Create;True;0;0;0;False;0;False;1;1.35;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;31;-160.619,153.7891;Inherit;False;Property;_Dessaturation;Dessaturation;6;0;Create;True;0;0;0;False;0;False;0;0.73;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;32;208.1709,127.486;Inherit;False;Property;_smoothness;smoothness;7;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;34;279.9896,450.0956;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.NormalVertexDataNode;33;-24.21035,548.895;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;35;218.8893,598.2959;Inherit;False;FLOAT3;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=AEC0171F00F03ADFC19DF36FB7C7871921664924